...
static const struct pvr_format pvr_format_table[] = {
   ...
   FORMAT_COMPRESSED(ASTC_4x4, ASTC_4X4),
   FORMAT_COMPRESSED(ASTC_4x4_SRGB, ASTC_4X4),
   FORMAT_COMPRESSED(ASTC_5x4, ASTC_5X4),
   FORMAT_COMPRESSED(ASTC_5x4_SRGB, ASTC_5X4),
   FORMAT_COMPRESSED(ASTC_5x5, ASTC_5X5),
   FORMAT_COMPRESSED(ASTC_5x5_SRGB, ASTC_5X5),
   FORMAT_COMPRESSED(ASTC_6x5, ASTC_6X5),
   FORMAT_COMPRESSED(ASTC_6x5_SRGB, ASTC_6X5),
   FORMAT_COMPRESSED(ASTC_6x6, ASTC_6X6),
   FORMAT_COMPRESSED(ASTC_6x6_SRGB, ASTC_6X6),
   FORMAT_COMPRESSED(ASTC_8x5, ASTC_8X5),
   FORMAT_COMPRESSED(ASTC_8x5_SRGB, ASTC_8X5),
   FORMAT_COMPRESSED(ASTC_8x6, ASTC_8X6),
   FORMAT_COMPRESSED(ASTC_8x6_SRGB, ASTC_8X6),
   FORMAT_COMPRESSED(ASTC_8x8, ASTC_8X8),
   FORMAT_COMPRESSED(ASTC_8x8_SRGB, ASTC_8X8),
   FORMAT_COMPRESSED(ASTC_10x5, ASTC_10X5),
   FORMAT_COMPRESSED(ASTC_10x5_SRGB, ASTC_10X5),
   FORMAT_COMPRESSED(ASTC_10x6, ASTC_10X6),
   FORMAT_COMPRESSED(ASTC_10x6_SRGB, ASTC_10X6),
   FORMAT_COMPRESSED(ASTC_10x8, ASTC_10X8),
   FORMAT_COMPRESSED(ASTC_10x8_SRGB, ASTC_10X8),
   FORMAT_COMPRESSED(ASTC_10x10, ASTC_10X10),
   FORMAT_COMPRESSED(ASTC_10x10_SRGB, ASTC_10X10),
   FORMAT_COMPRESSED(ASTC_12x10, ASTC_12X10),
   FORMAT_COMPRESSED(ASTC_12x10_SRGB, ASTC_12X10),
   FORMAT_COMPRESSED(ASTC_12x12, ASTC_12X12),
   FORMAT_COMPRESSED(ASTC_12x12_SRGB, ASTC_12X12),
